...
async updateFile(
  ...
  @Post('send-birthday-whatsapp')
  @HttpCode(HttpStatus.OK)
  async sendBirthdayWhatsapp(@Body() sendBirthdayWhatsappDto: SendBirthdayWhatsappDto) {
    const { phoneNumber, nombre, apellido } = sendBirthdayWhatsappDto;
